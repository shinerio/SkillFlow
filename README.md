...
| **Starred Repos** | Watch Git repos and recursively browse/import nested repo skills without adding them to your library first; supports GitHub Star auto-capture (PAT), deep `skill.md`/`SKILL.md` detection, and source badges (`manual`/`star`) on repo cards |
