...
| **Settings** | Per-tool enable/disable, push & scan paths (text input + folder picker), default pull category (`Default` by default), custom tools, cloud credentials, proxy configuration |
